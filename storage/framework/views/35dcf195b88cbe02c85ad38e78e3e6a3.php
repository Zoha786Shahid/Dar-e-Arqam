...
<?php $__env->startSection('content'); ?>
    <main>
        <div class="tp-hero-area-two  pt-130 p-relative fix">
            <div class="tp-hero-yellow-shape d-none d-lg-block"></div>
            <div class="ce-hero-shape d-none d-lg-block">
                <img src="<?php echo e(URL::asset('front/assets/img/hero/hero-shape-4.png')); ?>" alt="">
            </div>
            <div class="ce-hero-shape-two d-none d-lg-block">
                <img src="<?php echo e(URL::asset('front/assets/img/hero/hero-shape-4.1.png')); ?>" alt="">
            </div>
            <div class="container">
                <div class="row">
                    <div class="col-xl-6 col-lg-6">
                        <div class="tp-hero-section-box tp-hero-section-box-four pt-120 pb-140">
                            <h3 class="tp-hero-bd-title text-black wow tpfadeUp" data-wow-duration=".3s" data-wow-delay=".6s">Crafting Digital
                            ...
                            <p class="wow tpfadeUp" data-wow-duration=".5s" data-wow-delay=".7s">At Tekinity, we excel in designing, building, and delivering beautiful, user-friendly digital products with unparalleled efficiency. We are your trusted partner in the digital world.</p>
                            <div class="tp-hero-three-button-box d-flex align-items-center wow tpfadeUp" data-wow-duration=".7s" data-wow-delay=".9s">
                                <a class="tp-btn mr-55" href="about-me.html">Our Vision</a>
                        ...
                        <div class="tp-hero-social pb-90 wow tpfadeUp" data-wow-duration=".7s" data-wow-delay=".9s">
                            <div class="tp-hero-social bp-hero-social">
                                <a class="social-icon-1" href="#"><i class="fab fa-facebook-f social-icon-1"></i><span>Facebook</span></a>
                                <a class="social-icon-3" href="#"><i class="fab fa-youtube social-icon-3"></i><span>youtube</span></a>
                                <a class="social-icon-2" href="#"><i class="fab fa-twitter social-icon-2"></i><span>twitter</span></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-6 col-lg-6 wow fadeInRight" data-wow-duration=".7s" data-wow-delay=".9s">
                        <div class="tp-hero-right-img-four pt-90">
                            <img src="<?php echo e(URL::asset('front/assets/img/hero/hero-5.png')); ?>" alt="">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <!-- tp-barnd-area-start -->
        <div class="tp-brand-area pt-130 pb-130 grey-bg">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="swiper-wrapper d-flex align-items-center">
                            <div class="swiper-slide">
                                <div class="tp-brand-icon text-center">
                                    <img src="<?php echo e(URL::asset('front/assets/img/brand/brand-1.png')); ?>" alt="">
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="tp-brand-icon text-center">
                                    <img src="<?php echo e(URL::asset('front/assets/img/brand/brand-2.png')); ?>" alt="">
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="tp-brand-icon text-center">
                                    <img src="<?php echo e(URL::asset('front/assets/img/brand/brand-3.png')); ?>" alt="">
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="tp-brand-icon text-center">
                                    <img src="<?php echo e(URL::asset('front/assets/img/brand/brand-4.png')); ?>" alt="">
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="tp-brand-icon text-center">
                                    <img src="<?php echo e(URL::asset('front/assets/img/brand/brand-5.png')); ?>" alt="">
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="tp-brand-icon text-center">
                                    <img src="<?php echo e(URL::asset('front/assets/img/brand/brand-6.png')); ?>" alt="">
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="tp-brand-icon text-center">
        ...
        <div class="tp-service-area pb-90 grey-bg">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-xl-3 col-lg-4 col-md-6 wow tpfadeUp" data-wow-duration=".3s" data-wow-delay=".5s">
                        <div class="tp-sv-border-effect">
                            <div class="tp-service-item-four sv-color-1 mb-30">
                                <div class="tp-service-item-four__img  mb-40">
                                    <img src="<?php echo e(URL::asset('front/assets/img/service/007-email.png')); ?>" alt="">
                                </div>
                                <div class="tp-service-item-four__title">
                                    <h3 class="tp-sv-sm-title"><a href="service-details.html">Product Management</a></h3>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-4 col-md-6 wow tpfadeUp" data-wow-duration=".5s" data-wow-delay=".7s">
                        <div class="tp-sv-border-effect sv-border-effect-1">
                            <div class="tp-service-item-four sv-color-2 mb-30">
                                <div class="tp-service-item-four__img  mb-40">
                                    <img src="<?php echo e(URL::asset('front/assets/img/service/service4.1.png')); ?>"
                                        alt="">
                                </div>
                                <div class="tp-service-item-four__title">
                                    <h3 class="tp-sv-sm-title"><a href="service-details.html">Web & Mobile Development</a>
                                    </h3>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-4 col-md-6  wow tpfadeUp" data-wow-duration=".7s" data-wow-delay=".9s">
                        <div class="tp-sv-border-effect sv-border-effect-2">
                            <div class="tp-service-item-four sv-color-3 mb-30">
                                <div class="tp-service-item-four__img mb-40">
                                    <img src="<?php echo e(URL::asset('front/assets/img/service/service4.2.png')); ?>"
                                        alt="">
                                </div>
                                <div class="tp-service-item-four__title">
                                    <h3 class="tp-sv-sm-title"><a href="service-details.html">Fast Customer
                                            Support</a></h3>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-4 col-md-6  wow tpfadeUp" data-wow-duration=".9s" data-wow-delay="1s">
                        <div class="tp-sv-border-effect sv-border-effect-3">
                            <div class="tp-service-item-four sv-color-4 mb-30">
                                <div class="tp-service-item-four__img mb-40">
                                    <img src="<?php echo e(URL::asset('front/assets/img/service/service4.3.png')); ?>"
                                        alt="">
                                </div>
                                <div class="tp-service-item-four__title">
                                    <h3 class="tp-sv-sm-title"><a href="service-details.html">Human <br>
                                            Resources</a></h3>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6  wow tpfadeUp" data-wow-duration=".9s" data-wow-delay="1.1s">
                        <div class="tp-sv-border-effect sv-border-effect-4">
                            <div class="tp-service-item-four sv-color-5 mb-30">
                                <div class="tp-service-item-four__img mb-40">
                                    <img src="<?php echo e(URL::asset('front/assets/img/service/service4.4.png')); ?>"
                                        alt="">
                                </div>
                                <div class="tp-service-item-four__title">
                                    <h3 class="tp-sv-sm-title"><a href="service-details.html">Design and
                                            Vreatives</a></h3>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-4 col-md-6  wow tpfadeUp" data-wow-duration="1s" data-wow-delay="1.1s">
                        <div class="tp-sv-border-effect sv-border-effect-5">
                            <div class="tp-service-item-four sv-color-6 mb-30">
                                <div class="tp-service-item-four__img mb-40">
                                    <img src="<?php echo e(URL::asset('front/assets/img/service/service4.5.png')); ?>"
                                        alt="">
                                </div>
                                <div class="tp-service-item-four__title">
                                    <h3 class="tp-sv-sm-title"><a href="service-details.html">Marketing and
                                            Communication</a></h3>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-4 col-md-6  wow tpfadeUp" data-wow-duration="1s" data-wow-delay="1.2s">
                        <div class="tp-sv-border-effect sv-border-effect-6">
                            <div class="tp-service-item-four sv-color-7 mb-30">
                                <div class="tp-service-item-four__img mb-40">
                                    <img src="<?php echo e(URL::asset('front/assets/img/service/service4.6.png')); ?>"
                                        alt="">
                                </div>
                                <div class="tp-service-item-four__title">
                                    <h3 class="tp-sv-sm-title"><a href="service-details.html">Data and
                                            Analysis</a></h3>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-xl-6 col-lg-6 wow tpfadeLeft" data-wow-duration=".5s" data-wow-delay=".5s">
                        <div class="tp-fea-img">
                            <img src="<?php echo e(URL::asset('front/assets/img/feature/fea-1.png')); ?>" alt="">
                        </div>
                    </div>
                    <div class="col-xl-6 col-lg-6  wow tpfadeRight" data-wow-duration=".5s" data-wow-delay=".7s">
                        <div class="tp-fea-right-side">
                            <div class="tp-fea-section-box">
                                ...
                                <h2 class="tp-title-sm pb-40">Specialist in aviding clients
                                    of financial
                                    <span class="tp-section-highlight">
                                        challenges
                            ...
                            <div class="fea-wrapper-main">
                                <div class="tp-feature-list d-flex">
                                    ...
                                    <div class="tp-feature-list__content">
                                        ...
                                        <p>At collax we specialize in designing, building, <br> shipping and scaling
                                            beautifu.</p>
                                    </div>
                                </div>
                                <div class="tp-feature-list  d-flex">
        ...
        <!-- project-area start-->
        <div class="tp-project-area tp-cc-project grey-bg pt-130 pb-100">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-xl-8">
                        <div class="tp-project-section-box text-center pb-25">
                            <h5 class="tp-subtitle">Projects</h5>
                            <h2 class="tp-title-sm pb-30">Collax complete
                                <span class="tp-section-highlight">
                                    project
                ...
                <div class="row grid">
                    <div class="col-xl-8 col-lg-8 col-md-12 grid-item  cat2 cat5 cat4">
                        <div class="tp-project-item-four mb-30 tp-img-reveal-item" data-subtitle="Branding"
                            data-title="Book art design" data-fx="1">
                            <div class="tp-project-item-four__img fix">
                                <a href="#"><img class="w-100" src="<?php echo e(URL::asset('front/assets/img/project/project-4.1.jpg')); ?>"
                                        alt=""></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-4 col-md-6 grid-item  cat3 cat5">
                        <div class="tp-project-item-four mb-30 tp-img-reveal-item" data-subtitle="Design"
                            data-title="Graphic Design" data-fx="1">
                            <div class="tp-project-item-four__img fix">
                                <a href="#"><img class="w-100" src="<?php echo e(URL::asset('front/assets/img/project/project-4.2.jpg')); ?>"
                                        alt=""></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-4 col-md-6 grid-item  cat3 cat5">
                        <div class="tp-project-item-four mb-30 tp-img-reveal-item" data-subtitle="Design"
                            data-title="3d Digital Art" data-fx="1">
                            <div class="tp-project-item-four__img fix">
                                <a href="#"><img class="w-100" src="<?php echo e(URL::asset('front/assets/img/project/project-4.3.jpg')); ?>"
                                        alt=""></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-4 col-md-6 grid-item  cat3 cat5">
                        <div class="tp-project-item-four mb-30 tp-img-reveal-item" data-subtitle="Design"
                            data-title="Web Design" data-fx="1">
                            <div class="tp-project-item-four__img fix">
                                <a href="#"><img class="w-100" src="<?php echo e(URL::asset('front/assets/img/project/project-4.4.jpg')); ?>"
                                        alt=""></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-4 col-md-6 grid-item  cat3 cat5">
                        <div class="tp-project-item-four mb-30 tp-img-reveal-item" data-subtitle="Design"
                            data-title="Mobile App Design" data-fx="1">
                            <div class="tp-project-item-four__img fix">
                                <a href="#"><img class="w-100" src="<?php echo e(URL::asset('front/assets/img/project/project-4.5.jpg')); ?>"
                                        alt=""></a>
                            </div>
                        </div>
                    </div>
        ...
        <div class="tp-testimonial-area pt-130 pb-130 p-relative">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-xl-12">
                        <div class="tp-testi-wrapper d-flex pb-70 justify-content-between align-items-end">
                            ...
                            <div class="tp-testi-button-right-side">
                                <a class="tp-btn" href="testimonial.html">More Testimonial</a>
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="tp-testimonial-item-four">
                                    <div
                                        ...
                                        <div class="tp-testimonial-item-four__logo">
                                            <a href=""><img src="<?php echo e(URL::asset('front/assets/img/testimonial/testi-brands-1.png')); ?>"
                                                    alt=""></a>
                                        </div>
                                    ...
                                    <div class="tp-testi-paragraph pb-40">
                                        <p>Wow. What a great experience with this copywriter. Muhammad Noman is a very
                                            talented
                                    ...
                                    <div class="tp-testimonial-item-four__client d-flex align-items-center">
                                        <div class="mr-20">
                                            <img src="<?php echo e(URL::asset('front/assets/img/testimonial/testi-4.2.png')); ?>" alt="">
                                        </div>
                            ...
                            <div class="swiper-slide">
                                <div class="tp-testimonial-item-four">
                                    <div
                                        class="tp-testimonial-item-four__meta d-flex justify-content-between align-items-center mb-60">
                                        <div class="tp-testimonial-item-four__logo">
                                            <a href=""><img src="<?php echo e(URL::asset('front/assets/img/testimonial/testi-brands-2.png')); ?>"
                                                    alt=""></a>
                                        </div>
                                        <div class="tp-testimonial-item-four__rating">
                                            <span><i class="fas fa-star"></i></span>
                                    ...
                                    <div class="tp-testi-paragraph pb-40">
                                        <p>Excellent UI/Ux Design. She literally transformed my App into a wonderful piece
                                            of art.
                                            She's got awesome Ui design skills. - Hardworking Dedicated Great Communication
                                            Skills
                                        </p>
                                    </div>
                                    <div class="tp-testimonial-item-four__client d-flex align-items-center">
                                        <div class="mr-20">
                                            <img src="<?php echo e(URL::asset('front/assets/img/testimonial/testi-4.5.png')); ?>" alt="">
                                        </div>
                                        <div class="tp-testimonial-item-four__position">
                            ...
                            <div class="swiper-slide">
                                <div class="tp-testimonial-item-four">
                                    <div
                                        class="tp-testimonial-item-four__meta d-flex justify-content-between align-items-center mb-60">
                                        <div class="tp-testimonial-item-four__logo">
                                            <a href=""><img src="<?php echo e(URL::asset('front/assets/img/testimonial/testi-brands-3.png')); ?>"
                                                    alt=""></a>
                                        </div>
                                        <div class="tp-testimonial-item-four__rating">
                                            <span><i class="fas fa-star"></i></span>
                                    ...
                                    <div class="tp-testi-paragraph pb-40">
                                        <p>Absolutely amazing. we can't believe how incredible this turned out. Yetta Thomas
                                            is a
                                    ...
                                    <div class="tp-testimonial-item-four__client d-flex align-items-center">
                                        <div class="mr-20">
                                            <img src="<?php echo e(URL::asset('front/assets/img/testimonial/testi-4.1.png')); ?>" alt="">
                                        </div>
                                        <div class="tp-testimonial-item-four__position">
        ...
        <!-- news-area-start -->
        <div class="tp-news-letter-area tp-news-letter-bg pt-130 pb-130" data-background="<?php echo e(URL::asset('front/assets/img/news/news-bg.jpg')); ?>">
            <div class="container">
                <div class="row align-items-center wow tpfadeUp" data-wow-duration=".3s" data-wow-delay=".5s">
                    <div class="col-xl-7 col-lg-7 col-md-12 ">
                        <div class="tp-news-sub-wrapper pr-50">
                            <div class="tp-news-letter-section-box">
                                ...
                                <h2 class="tp-title-sm tp-title-sm tp-white-text pb-25">Subscribe newslater get latest
                                    updates
                                    and deals
                                </h2>
                            </div>
                            <div class="tp-news-button p-relative">
                                <form action="#">
                                    ...
                                    <button class="tp-submit-button tp-btn-yellow" type="submit">Subscribe <i
                    ...
                    <div class="col-xl-5 col-lg-5 col-md-12">
                        <div class="tp-news-letter-img text-md-start text-lg-end pr-45">
                            <img src="<?php echo e(URL::asset('front/assets/img/news/news-3.png')); ?>" alt="">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <!-- blog-area-start -->
        <div class="tp-blog-area pt-130 pb-90 grey-bg p-relative">
            <div class="ce-blog-shape d-none d-lg-block">
                <img src="<?php echo e(URL::asset('front/assets/img/hero/hero-shape-4.png')); ?>" alt="">
            </div>
            <div class="container">
                <div class="row">
                    <div class="tp-testimonial-section-box text-center pb-70">
                        <h5 class="tp-subtitle">Blog Post</h5>
                        <h2 class="tp-title-sm">Popular
                            <span class="tp-section-highlight">
                                blog post
                                <svg width="212" height="11" viewBox="0 0 212 11" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="row gx-7">
                    <div class="col-xl-6 col-lg-6 tp-blog-border mb-40  wow tpfadeLeft" data-wow-duration=".3s"
                        data-wow-delay=".5s">
                        <div class="tp-blog-item-four">
                            <div class="tp-blog-item-four__img mb-40 fix">
                                <a href="#"><img class="w-100" src="<?php echo e(URL::asset('front/assets/img/blog/blog-8.jpg')); ?>"
                                        alt=""></a>
                            </div>
                            <div class="tp-blog-item-four__content">
                                <div class="tp-blog-item-four__meta mb-20">
                                    <a href="blog-details.html">Development</a>
                                    <a class="tp-meta-text" href="blog-details.html"><i class="fal fa-clock"></i> July
                                        22, 2022</a>
                                </div>
                                <div class="tp-blog-item-four__title">
                                    <h4 class="tp-blog-user-title"><a href="blog-details.html">Godaddy user flow
                                            solution...</a></h4>
                                    <p class="p-0 mb-0">At Collax we specialize in designing, building, shipping and
                                        scaling
                                        beautifu. At Collax
                                        we
                                        specialize in designing, building, shipping and scaling beautiful.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-6 col-lg-6 wow tpfadeRight" data-wow-duration=".5s" data-wow-delay=".7s">
                        <div class="row">
                            <div class="col-xl-12 mb-40">
                                <div class="tp-blog-right-side-sm d-flex align-items-center">
                                    <div class="tp-blog-right-side-sm__img fix mr-40">
                                        <a href="#"><img src="<?php echo e(URL::asset('front/assets/img/blog/blog-sm-1.jpg')); ?>" alt=""></a>
                                    </div>
                                    <div class="tp-blog-right-side-sm__content">
                                        <div class="tp-blog-right-side-sm__meta mb-25">
                                            <a href="blog-details.html">Development</a>
                                            <a class="tp-meta-text" href="#"><i class="fal fa-clock"></i> July 21,
                                                2020</a>
                                        </div>
                                        <div class="tp-blog-right-side-sm__title">
                                            <h4 class="tp-blog-user-sm-title"><a href="blog-details.html">Godaddy user
                                                    flow solution
                                                    for every individual</a></h4>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-12 mb-40">
                                <div class="tp-blog-right-side-sm d-flex align-items-center">
                                    <div class="tp-blog-right-side-sm__img fix mr-40">
                                        <a href="#"><img src="<?php echo e(URL::asset('front/assets/img/blog/blog-sm-2.png')); ?>" alt=""></a>
                                    </div>
                                    <div class="tp-blog-right-side-sm__content">
                                        <div class="tp-blog-right-side-sm__meta mb-25">
                                        ...
                                        <div class="tp-blog-right-side-sm__title">
                                            <h4 class="tp-blog-user-sm-title"><a href="blog-details.html">Business
                                                    solution for every
                                                    individual</a></h4>
                                        </div>
                                    </div>
                            ...
                            <div class="col-xl-12 mb-40">
                                <div class="tp-blog-right-side-sm d-flex align-items-center">
                                    <div class="tp-blog-right-side-sm__img fix mr-40">
                                        <a href="#"><img src="<?php echo e(URL::asset('front/assets/img/blog/blog-sm-3.png')); ?>" alt=""></a>
                                    </div>
                                    <div class="tp-blog-right-side-sm__content">
                                        <div class="tp-blog-right-side-sm__meta mb-25">
                                            <a href="blog-details.html">Development</a>
                                        ...
                                        <div class="tp-blog-right-side-sm__title">
                                            <h4 class="tp-blog-user-sm-title"><a href="blog-details.html">How to gain pro
                                                    experience
                                                    ar figma update version</a></h4>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<?php echo $__env->make('front.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Work\tekinity\tekinity-business-old\resources\views/front/pages/home.blade.php ENDPATH**/ ?>