                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                <li><a class="dropdown-item" href="<?php echo e(route('campus.edit', $campus->id)); ?>">Edit</a></li>
                                                <li>
                                                    <a class="dropdown-item" href="#" onclick="confirmDelete(event, 'delete-form-<?php echo e($campus->id); ?>')">
                                                        Delete
                                                    </a>
                                                </li>
                                                <form id="delete-form-<?php echo e($campus->id); ?>" action="<?php echo e(route('campus.destroy', $campus->id)); ?>" method="POST" style="display: none;">
                                                    <?php echo csrf_field(); ?>
