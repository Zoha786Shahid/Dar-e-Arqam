        ...
        <div class="col-xl-3 col-lg-6">
            <div class="card ribbon-box right overflow-hidden">
                <div class="card-body text-center p-4">
                    ...
                    <h5 class="mb-1 mt-4"><a href="<?php echo e(URL::asset('/apps-ecommerce-seller-details')); ?>" class="link-primary">Force
                            Medicines</a></h5>
        ...
        <div class="col-xl-3 col-lg-6">
            <div class="card">
                <div class="card-body text-center p-4">
                    ...
                    <h5 class="mb-1 mt-4"><a href="<?php echo e(URL::asset('/apps-ecommerce-seller-details')); ?>" class="link-primary">Micro
                            Design</a></h5>
        ...
        <div class="col-xl-3 col-lg-6">
            <div class="card">
                <div class="card-body text-center p-4">
                    ...
                    <h5 class="mb-1 mt-4"><a href="<?php echo e(URL::asset('/apps-ecommerce-seller-details')); ?>" class="link-primary">Nesta
                            Technologies</a></h5>
        ...
        <div class="col-xl-3 col-lg-6">
            <div class="card ribbon-box right overflow-hidden">
                <div class="card-body text-center p-4">
                    ...
                    <h5 class="mb-1 mt-4"><a href="<?php echo e(URL::asset('/apps-ecommerce-seller-details')); ?>" class="link-primary">iTest
                            Factory</a></h5>
        ...
        <div class="col-xl-3 col-lg-6">
            <div class="card ribbon-box right overflow-hidden">
                <div class="card-body text-center p-4">
                    ...
                    <h5 class="mb-1 mt-4"><a href="<?php echo e(URL::asset('/apps-ecommerce-seller-details')); ?>" class="link-primary">Syntyce
                            Solutions</a></h5>
        ...
        <div class="col-xl-3 col-lg-6">
            <div class="card">
                <div class="card-body text-center p-4">
                    ...
                    <h5 class="mb-1 mt-4"><a href="<?php echo e(URL::asset('/apps-ecommerce-seller-details')); ?>" class="link-primary">Zoetic
                            Fashion</a></h5>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Tarun\Laravel Admins\velzon_laravel\Laravel\material\resources\views/apps-ecommerce-sellers.blade.php ENDPATH**/ ?>