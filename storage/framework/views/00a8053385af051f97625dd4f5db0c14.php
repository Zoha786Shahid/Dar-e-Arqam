            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="<?php echo e(route('evaluation.update', $evaluation->id)); ?>">
                        <?php echo csrf_field(); ?>
                        <?php echo method_field('PUT'); ?> <!-- Specify PUT for updating -->
                        <div class="row gy-4">
                            ...
                            <div class="col-xxl-4 col-md-6">
                                <div>
                                    ...
                                    <input type="number" class="form-control" id="total_students" name="total_students"
                                        value="<?php echo e(old('total_students', $evaluation->total_students)); ?>"
                            ...
                            <div class="col-xxl-4 col-md-6">
                                <div>
                                    ...
                                    <input type="number" class="form-control" id="appearance_dress_code"
                                        ...
                                        value="<?php echo e(old('appearance_dress_code', $evaluation->appearance_dress_code)); ?>"
                            ...
                            <div class="col-xxl-4 col-md-6">
                                <div>
                                    ...
                                    <input type="number" class="form-control" id="lesson_plan" name="lesson_plan"
                                        value="<?php echo e(old('lesson_plan', $evaluation->lesson_plan)); ?>"
                            ...
                            <div class="col-xxl-4 col-md-6">
                                <div>
                                    ...
                                    <input type="text" class="form-control" id="observer_signature"
                                        ...
                                        value="<?php echo e(old('observer_signature', $evaluation->observer_signature)); ?>"
                            ...
                            <div class="col-xxl-4 col-md-6">
                                <div>
                                    ...
                                    <input type="number" class="form-control" id="standard_of_lesson_plan"
                                        ...
                                        value="<?php echo e(old('standard_of_lesson_plan', $evaluation->standard_of_lesson_plan)); ?>"
                            ...
                            <div class="col-xxl-4 col-md-6">
                                <div>
                                    ...
                                    <input type="number" class="form-control" id="introduction_pk_testing"
                                        ...
                                        value="<?php echo e(old('introduction_pk_testing', $evaluation->introduction_pk_testing)); ?>"
                            ...
                            <div class="col-xxl-4 col-md-6">
                                <div>
                                    ...
                                    <input type="number" class="form-control" id="islamization" name="islamization"
                                        value="<?php echo e(old('islamization', $evaluation->islamization)); ?>"
                            ...
                            <div class="col-xxl-4 col-md-6">
                                <div>
                                    ...
                                    <input type="number" class="form-control" id="gesture_tone_body_language"
                                        ...
                                        value="<?php echo e(old('gesture_tone_body_language', $evaluation->gesture_tone_body_language)); ?>"
                            ...
                            <div class="col-xxl-4 col-md-6">
                                <div>
                                    ...
                                    <input type="number" class="form-control" id="communication_skill"
                                        ...
                                        value="<?php echo e(old('communication_skill', $evaluation->communication_skill)); ?>"
                            ...
                            <div class="col-xxl-4 col-md-6">
                                <div>
                                    ...
                                    <input type="number" class="form-control" id="strategies_activities"
                                        ...
                                        value="<?php echo e(old('strategies_activities', $evaluation->strategies_activities)); ?>"
                            ...
                            <div class="col-xxl-4 col-md-6">
                                <div>
                                    ...
                                    <input type="number" class="form-control" id="discipline_class_control"
                                        ...
                                        value="<?php echo e(old('discipline_class_control', $evaluation->discipline_class_control)); ?>"
                            ...
                            <div class="col-xxl-4 col-md-6">
                                <div>
                                    ...
                                    <input type="number" class="form-control" id="tools_av_aids" name="tools_av_aids"
                                        value="<?php echo e(old('tools_av_aids', $evaluation->tools_av_aids)); ?>"
                            ...
                            <div class="col-xxl-4 col-md-6">
                                <div>
                                    ...
                                    <input type="number" class="form-control" id="tools_illustrative_material"
                                        ...
                                        value="<?php echo e(old('tools_illustrative_material', $evaluation->tools_illustrative_material)); ?>"
                            ...
                            <div class="col-xxl-4 col-md-6">
                                <div>
                                    ...
                                    <input type="number" class="form-control" id="tools_writing_board"
                                        ...
                                        value="<?php echo e(old('tools_writing_board', $evaluation->tools_writing_board)); ?>"
                            ...
                            <div class="col-xxl-4 col-md-6">
                                <div>
                                    ...
                                    <input type="number" class="form-control" id="real_life_integration"
                                        ...
                                        value="<?php echo e(old('real_life_integration', $evaluation->real_life_integration)); ?>"
                            ...
                            <div class="col-xxl-4 col-md-6">
                                <div>
                                    ...
                                    <input type="number" class="form-control" id="competency_command_on_subject"
                                        ...
                                        value="<?php echo e(old('competency_command_on_subject', $evaluation->competency_command_on_subject)); ?>"
                            ...
                            <div class="col-xxl-4 col-md-6">
                                <div>
                                    ...
                                    <input type="number" class="form-control" id="time_management"
                                        ...
                                        value="<?php echo e(old('time_management', $evaluation->time_management)); ?>"
                            ...
                            <div class="col-xxl-4 col-md-6">
                                <div>
                                    ...
                                    <input type="number" class="form-control" id="evaluation_conclusion"
                                        ...
                                        value="<?php echo e(old('evaluation_conclusion', $evaluation->evaluation_conclusion)); ?>"
                            ...
                            <div class="col-xxl-4 col-md-6">
                                <div>
                                    ...
                                    <input type="number" class="form-control" id="diary_hw_checking"
                                        ...
                                        value="<?php echo e(old('diary_hw_checking', $evaluation->diary_hw_checking)); ?>"
                            ...
                            <div class="col-xxl-4 col-md-6">
                                <div>
                                    ...
                                    <input type="number" class="form-control" id="call_on_board" name="call_on_board"
                                        value="<?php echo e(old('call_on_board', $evaluation->call_on_board)); ?>"
                            ...
                            <div class="col-xxl-4 col-md-6">
                                <div>
                                    ...
                                    <input type="number" class="form-control" id="knowledge_gain" name="knowledge_gain"
                                        value="<?php echo e(old('knowledge_gain', $evaluation->knowledge_gain)); ?>"
                            ...
                            <div class="col-xxl-4 col-md-6">
                                <div>
                                    ...
                                    <input type="number" class="form-control" id="skill_gain_spoken"
                                        ...
                                        value="<?php echo e(old('skill_gain_spoken', $evaluation->skill_gain_spoken)); ?>"
                            ...
                            <div class="col-xxl-4 col-md-6">
                                <div>
                                    ...
                                    <input type="number" class="form-control" id="skill_gain_written"
                                        ...
                                        value="<?php echo e(old('skill_gain_written', $evaluation->skill_gain_written)); ?>"
                            ...
                            <div class="col-xxl-4 col-md-6">
                                <div>
                                    ...
                                    <input type="number" class="form-control" id="personality_trait_confidence"
                                        ...
                                        value="<?php echo e(old('personality_trait_confidence', $evaluation->personality_trait_confidence)); ?>"
                            ...
                            <div class="col-xxl-4 col-md-6">
                                <div>
                                    ...
                                    <input type="number" class="form-control" id="response_of_previous_knowledge"
                                        ...
                                        value="<?php echo e(old('response_of_previous_knowledge', $evaluation->response_of_previous_knowledge)); ?>"
                            ...
                            <div class="col-xxl-4 col-md-6">
                                <div>
                                    ...
                                    <input type="number" class="form-control" id="percentage" name="percentage"
                                        value="<?php echo e(old('percentage', $evaluation->percentage)); ?>" placeholder="Percentage"
                                        readonly>
                                </div>
                            </div>
                        ...
                        success: function (data) {
                            ...
                            if (Array.isArray(data) && data.length > 0) {
                                $.each(data, function (index, teacher) {
                                    const isSelected = selectedTeacherId == teacher.id ? 'selected' : ''; // Retain selected teacher
