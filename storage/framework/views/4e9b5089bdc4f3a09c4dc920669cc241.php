        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    ...
                    <a href="<?php echo e(route('permissions.index')); ?>" class="btn btn-primary ms-auto">Back</a>
                </div><!-- end card header -->
                <div class="card-body">
...
unset($__errorArgs, $__bag); ?>"
                                        id="guard_name" name="guard_name" value="<?php echo e(old('guard_name', 'web')); ?>"
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wamp\www\Dar-e-Arqam\resources\views/permissions/create.blade.php ENDPATH**/ ?>