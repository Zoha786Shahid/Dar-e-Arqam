                    ...
                    <ul class="list-unstyled vstack gap-3 mb-0">
                        <li>
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1 ms-2">
                                    <h6 class="mb-1"><a href="<?php echo e(URL::asset('/pages-profile')); ?>" class="text-body">Tonya
                                            Noble</a></h6>
                        ...
                        <li>
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1 ms-2">
                                    <h6 class="mb-1"><a href="<?php echo e(URL::asset('/pages-profile')); ?>" class="text-body">Thomas
                                            Taylor</a></h6>
                        ...
                        <li>
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1 ms-2">
                                    <h6 class="mb-1"><a href="<?php echo e(URL::asset('/pages-profile')); ?>" class="text-body">Nancy
                                            Martino</a></h6>
                            ...
                            <div data-simplebar style="height: 508px;" class="px-3 mx-n3 mb-2">
                                <div class="d-flex mb-4">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        <h5 class="fs-13"><a href="<?php echo e(URL::asset('/pages-profile')); ?>"
                                        ...
                                        <tr>
                                            <th scope="row">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="flex-grow-1 ms-2">
                                                        <a href="<?php echo e(URL::asset('/pages-profile')); ?>" class="fw-medium text-body">Thomas
                                                            Taylor</a>
                                                    </div>
                                                </div>
                                            </th>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <img src="<?php echo e(URL::asset('assets/images/users/avatar-10.jpg')); ?>" alt=""
                                                        class="rounded-circle avatar-xxs">
                                                    <div class="flex-grow-1 ms-2">
                                                        <a href="<?php echo e(URL::asset('/pages-profile')); ?>" class="fw-medium text-body">Tonya
                                                            Noble</a>
                                                    </div>
                                                </div>
                                            </td>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Tarun\Laravel Admins\velzon_laravel\Laravel\material\resources\views/apps-tasks-details.blade.php ENDPATH**/ ?>