                            ...
                            <div class="col-xxl-4 col-md-6">
                                <div>
                                    ...
                                    <input type="number" class="form-control" id="entrance_welcome_marks"
                                        ...
                                        max="10"
                                        value="{{ old('entrance_welcome_marks', $evaluation->entrance_welcome_marks) }}"
                                        required>
                                </div>
                            </div>
                            ...
                            <div class="col-xxl-4 col-md-6">
                                <div>
                                    ...
                                    <input type="number" class="form-control" id="appearance_dress_code_marks"
                                        ...
                                        max="10"
                                        value="{{ old('appearance_dress_code_marks', $evaluation->appearance_dress_code_marks) }}"
                                        required>
                                </div>
                            </div>
                            ...
                            <div class="col-xxl-4 col-md-6">
                                <div>
                                    ...
                                    <input type="number" class="form-control" id="seating_cleanliness_marks"
                                        ...
                                        max="10"
                                        value="{{ old('seating_cleanliness_marks', $evaluation->seating_cleanliness_marks) }}"
                                        required>
                                </div>
                            </div>
                            ...
                            <div class="col-xxl-4 col-md-6">
                                <div>
                                    ...
                                    <input type="number" class="form-control" id="writing_board_prep_marks"
                                        ...
                                        max="10"
                                        value="{{ old('writing_board_prep_marks', $evaluation->writing_board_prep_marks) }}"
                                        required>
                                </div>
                            </div>
                            ...
                            <div class="col-xxl-4 col-md-6">
                                <div>
                                    ...
                                    <input type="number" class="form-control" id="writing_board_use_marks"
                                        ...
                                        max="10"
                                        value="{{ old('writing_board_use_marks', $evaluation->writing_board_use_marks) }}"
                                        required>
                                </div>
                            </div>
                            ...
                            <div class="col-xxl-4 col-md-6">
                                <div>
                                    ...
                                    <input type="number" class="form-control" id="syllabus_division_marks"
                                        ...
                                        max="10"
                                        value="{{ old('syllabus_division_marks', $evaluation->syllabus_division_marks) }}"
                                        required>
                                </div>
                            </div>
                            ...
                            <div class="col-xxl-4 col-md-6">
                                <div>
                                    ...
                                    <input type="number" class="form-control" id="assessment_start_marks"
                                        ...
                                        max="10"
                                        value="{{ old('assessment_start_marks', $evaluation->assessment_start_marks) }}"
                                        required>
                                </div>
                            </div>
                            ...
                            <div class="col-xxl-4 col-md-6">
                                <div>
                                    ...
                                    <input type="number" class="form-control" id="pk_testing_marks"
                                        ...
                                        value="{{ old('pk_testing_marks', $evaluation->pk_testing_marks) }}"
                            ...
                            <div class="col-xxl-4 col-md-6">
                                <div>
                                    ...
                                    <input type="number" class="form-control" id="av_activities_marks"
                                        ...
                                        max="10"
                                        value="{{ old('av_activities_marks', $evaluation->av_activities_marks) }}"
                                        required>
                                </div>
                            </div>
                            ...
                            <div class="col-xxl-4 col-md-6">
                                <div>
                                    ...
                                    <input type="number" class="form-control" id="teaching_methods_marks"
                                        ...
                                        max="10"
                                        value="{{ old('teaching_methods_marks', $evaluation->teaching_methods_marks) }}"
                                        required>
                                </div>
                            </div>
                            ...
                            <div class="col-xxl-4 col-md-6">
                                <div>
                                    ...
                                    <input type="number" class="form-control" id="subject_command_marks"
                                        ...
                                        max="10"
                                        value="{{ old('subject_command_marks', $evaluation->subject_command_marks) }}"
                                        required>
                                </div>
                            </div>
                            ...
                            <div class="col-xxl-4 col-md-6">
                                <div>
                                    ...
                                    <input type="number" class="form-control" id="student_clarity_marks"
                                        ...
                                        max="10"
                                        value="{{ old('student_clarity_marks', $evaluation->student_clarity_marks) }}"
                                        required>
                                </div>
                            </div>
                            ...
                            <div class="col-xxl-4 col-md-6">
                                <div>
                                    ...
                                    <input type="number" class="form-control" id="student_involvement_marks"
                                        ...
                                        max="10"
                                        value="{{ old('student_involvement_marks', $evaluation->student_involvement_marks) }}"
                                        required>
                                </div>
                            </div>
                            ...
                            <div class="col-xxl-4 col-md-6">
                                <div>
                                    ...
                                    <input type="number" class="form-control" id="individual_attention_marks"
                                        ...
                                        max="10"
                                        value="{{ old('individual_attention_marks', $evaluation->individual_attention_marks) }}"
                                        required>
                                </div>
                            </div>
                            ...
                            <div class="col-xxl-4 col-md-6">
                                <div>
                                    ...
                                    <input type="number" class="form-control" id="copy_work_marks"
                                        ...
                                        value="{{ old('copy_work_marks', $evaluation->copy_work_marks) }}" required>
                                </div>
                            </div>
                            ...
                            <div class="col-xxl-4 col-md-6">
                                <div>
                                    ...
                                    <input type="number" class="form-control" id="moral_training_marks"
                                        ...
                                        max="10"
                                        value="{{ old('moral_training_marks', $evaluation->moral_training_marks) }}"
                                        required>
                                </div>
                            </div>
                            ...
                            <div class="col-xxl-4 col-md-6">
                                <div>
                                    ...
                                    <input type="number" class="form-control" id="reading_marking_objective_marks"
                                        ...
                                        max="10"
                                        value="{{ old('reading_marking_objective_marks', $evaluation->reading_marking_objective_marks) }}"
                                        required>
                                </div>
                            </div>
                            ...
                            <div class="col-xxl-4 col-md-6">
                                <div>
                                    ...
                                    <input type="number" class="form-control" id="lecture_planning_marks"
                                        ...
                                        max="10"
                                        value="{{ old('lecture_planning_marks', $evaluation->lecture_planning_marks) }}"
                                        required>
                                </div>
                            </div>
                            ...
                            <div class="col-xxl-4 col-md-6">
                                <div>
                                    ...
                                    <input type="number" class="form-control" id="time_management_marks"
                                        ...
                                        max="10"
                                        value="{{ old('time_management_marks', $evaluation->time_management_marks) }}"
                                        required>
                                </div>
                            </div>
                            ...
                            <div class="col-xxl-4 col-md-6">
                                <div>
                                    ...
                                    <input type="number" class="form-control" id="spoken_english_marks"
                                        ...
                                        max="10"
                                        value="{{ old('spoken_english_marks', $evaluation->spoken_english_marks) }}"
                                        required>
                                </div>
                            </div>
                            ...
                            <div class="col-xxl-4 col-md-6">
                                <div>
                                    ...
                                    <input type="number" class="form-control" id="evaluation_marks"
                                        ...
                                        value="{{ old('evaluation_marks', $evaluation->evaluation_marks) }}" required>
                                </div>
                            </div>
                            ...
                            <div class="col-xxl-4 col-md-6">
                                <div>
                                    ...
                                    <input type="number" class="form-control" id="home_task_checking_marks"
                                        ...
                                        max="10"
                                        value="{{ old('home_task_checking_marks', $evaluation->home_task_checking_marks) }}"
                                        required>
                                </div>
                            </div>
                            ...
                            <div class="col-xxl-4 col-md-6">
                                <div>
                                    ...
                                    <input type="number" class="form-control" id="class_discipline_marks"
                                        ...
                                        value="{{ old('class_discipline_marks', $evaluation->class_discipline_marks) }}"
                                        max="10" required>
                                </div>
                            </div>
