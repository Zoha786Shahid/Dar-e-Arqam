...
<head>
    ...
    <style>
        @font-face {
            ...
            src: url('{{ resource_path('fonts/JameelNooriNastaleeq.ttf') }}') format('truetype');
        }
...
<body>
    ...
    <div class="details">
        <p><strong>استاد کا نام:</strong> {{ $evaluation->teacher->first_name }} {{ $evaluation->teacher->last_name }}
        </p>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><strong>{{ $evaluation->total_marks }}</strong></td>
            </tr>
        </tbody>
    </table>
