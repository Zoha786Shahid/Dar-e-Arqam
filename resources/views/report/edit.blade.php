        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0 flex-grow-1">ناظرہ رپورٹ - ترمیم</h4>
...
<div class="col-xxl-4 col-md-6">
    <div>
        <label for="evaluation_date" class="form-label">تاریخ</label>
                                        ...
                                        @for($i = 1; $i <= 5; $i++)
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="entrance_welcome" 
                                                    value="{{ $i }}" id="entrance_welcome_{{ $i }}" 
                                                    {{ old('entrance_welcome', $evaluation->entrance_welcome) == $i ? 'checked' : '' }}
                                        ...
                                        @for($i = 1; $i <= 5; $i++)
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="appearance_dress" 
                                                    value="{{ $i }}" id="appearance_dress_{{ $i }}" 
                                                    {{ old('appearance_dress', $evaluation->appearance_dress) == $i ? 'checked' : '' }}
                                                    onchange="calculateTotal()">
                                        ...
                                        @for($i = 1; $i <= 5; $i++)
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="teaching_style" 
                                                    value="{{ $i }}" id="teaching_style_{{ $i }}" 
                                                    {{ old('teaching_style', $evaluation->teaching_style) == $i ? 'checked' : '' }}
                                                    onchange="calculateTotal()">
                                        ...
                                        @for($i = 1; $i <= 5; $i++)
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="safety_cleanliness" 
                                                    value="{{ $i }}" id="safety_cleanliness_{{ $i }}" 
                                                    {{ old('safety_cleanliness', $evaluation->safety_cleanliness) == $i ? 'checked' : '' }}
                                                    onchange="calculateTotal()">
                                        ...
                                        @for($i = 1; $i <= 5; $i++)
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="discipline" 
                                                    value="{{ $i }}" id="discipline_{{ $i }}" 
                                                    {{ old('discipline', $evaluation->discipline) == $i ? 'checked' : '' }}
                                                    onchange="calculateTotal()">
                                        ...
                                        @for($i = 1; $i <= 5; $i++)
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="class_board" 
                                                    value="{{ $i }}" id="class_board_{{ $i }}" 
                                                    {{ old('class_board', $evaluation->class_board) == $i ? 'checked' : '' }}
                                                    onchange="calculateTotal()">
                                        ...
                                        @for($i = 1; $i <= 5; $i++)
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="teaching_plan" 
                                                    value="{{ $i }}" id="teaching_plan_{{ $i }}" 
                                                    {{ old('teaching_plan', $evaluation->teaching_plan) == $i ? 'checked' : '' }}
                                                    onchange="calculateTotal()">
                                        ...
                                        @for($i = 1; $i <= 5; $i++)
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="student_preparation" 
                                                    value="{{ $i }}" id="student_preparation_{{ $i }}" 
                                                    {{ old('student_preparation', $evaluation->student_preparation) == $i ? 'checked' : '' }}
                                                    onchange="calculateTotal()">
                                        ...
                                        @for($i = 1; $i <= 5; $i++)
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="conversation_standard" 
                                                    value="{{ $i }}" id="conversation_standard_{{ $i }}" 
                                                    {{ old('conversation_standard', $evaluation->conversation_standard) == $i ? 'checked' : '' }}
                                                    onchange="calculateTotal()">
                                        ...
                                        @for($i = 1; $i <= 5; $i++)
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="hifz_during_teaching" 
                                                    value="{{ $i }}" id="hifz_during_teaching_{{ $i }}" 
                                                    {{ old('hifz_during_teaching', $evaluation->hifz_during_teaching) == $i ? 'checked' : '' }}
                                                    onchange="calculateTotal()">
                                        ...
                                        @for($i = 1; $i <= 5; $i++)
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="hifz_fluency" 
                                                    value="{{ $i }}" id="hifz_fluency_{{ $i }}" 
                                                    {{ old('hifz_fluency', $evaluation->hifz_fluency) == $i ? 'checked' : '' }}
                                                    onchange="calculateTotal()">
                                        ...
                                        @for($i = 1; $i <= 5; $i++)
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="recitation" 
                                                    value="{{ $i }}" id="recitation_{{ $i }}" 
                                                    {{ old('recitation', $evaluation->recitation) == $i ? 'checked' : '' }}
                                                    onchange="calculateTotal()">
                                        ...
                                        @for($i = 1; $i <= 5; $i++)
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="moral_training" 
                                                    value="{{ $i }}" id="moral_training_{{ $i }}" 
                                                    {{ old('moral_training', $evaluation->moral_training) == $i ? 'checked' : '' }}
                                                    onchange="calculateTotal()">
                                        ...
                                        @for($i = 1; $i <= 5; $i++)
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="intellectual_moral_training" 
                                                    value="{{ $i }}" id="intellectual_moral_training_{{ $i }}" 
                                                    {{ old('intellectual_moral_training', $evaluation->intellectual_moral_training) == $i ? 'checked' : '' }}
                                                    onchange="calculateTotal()">
                                        ...
                                        @for($i = 1; $i <= 5; $i++)
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="physical_strength_health" 
                                                    value="{{ $i }}" id="physical_strength_health_{{ $i }}" 
                                                    {{ old('physical_strength_health', $evaluation->physical_strength_health) == $i ? 'checked' : '' }}
                                                    onchange="calculateTotal()">
                                        ...
                                        @for($i = 1; $i <= 5; $i++)
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="student_performance" 
                                                    value="{{ $i }}" id="student_performance_{{ $i }}" 
                                                    {{ old('student_performance', $evaluation->student_performance) == $i ? 'checked' : '' }}
                                                    onchange="calculateTotal()">
                                        ...
                                        @for($i = 1; $i <= 5; $i++)
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="diary" 
                                                    value="{{ $i }}" id="diary_{{ $i }}" 
                                                    {{ old('diary', $evaluation->diary) == $i ? 'checked' : '' }}
                                                    onchange="calculateTotal()">
