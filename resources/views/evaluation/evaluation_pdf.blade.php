            ...
            <div class="row teacher-info">
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" name="qualification" class="form-control"
                        value="{{ old('qualification', $evaluation->qualification ?? '') }}">
                </div>
                <div class="col-md-4">
            ...
            <div class="row teacher-info">
                <div class="col-md-4">
                    ...
                    <input type="text" name="class_sec" class="form-control"
                        value="{{ old('class_sec', $evaluation->class_sec ?? '') }}">
                </div>
                <div class="col-md-4">
                    <label>Subject:</label>
            ...
            <div class="row teacher-info">
                <div class="col-md-4">
                    ...
                    <input type="text" name="campus" class="form-control"
                        value="{{ old('campus', $evaluation->campus ?? '') }}">
                </div>
                <div class="col-md-4">
                    <label>Total Students:</label>
                    <input type="number" name="total_students" class="form-control"
                        value="{{ old('total_students', $evaluation->total_students ?? 0) }}">
                </div>
                <div class="col-md-4">
                    <label>Date:</label>
                ...
                <tbody>
                    <tr>
                        ...
                        <td><input type="number" name="checklist[1][obtained_marks]" class="form-control"
                                value="{{ old('checklist.1.obtained_marks', $evaluation->checklist[1]['obtained_marks'] ?? 0) }}"></td>
                        <td><input type="text" name="checklist[1][remarks]" class="form-control"
                                value="{{ old('checklist.1.remarks', $evaluation->checklist[1]['remarks'] ?? '') }}"></td>
                    </tr>
                    <tr>
                        <td>2</td>
                        ...
                        <td><input type="number" name="checklist[2][obtained_marks]" class="form-control"
                                value="{{ old('checklist.2.obtained_marks', $evaluation->checklist[2]['obtained_marks'] ?? 0) }}"></td>
                        <td><input type="text" name="checklist[2][remarks]" class="form-control"
                                value="{{ old('checklist.2.remarks', $evaluation->checklist[2]['remarks'] ?? '') }}"></td>
                    </tr>
                    <tr>
                        <td>3</td>
                        ...
                        <td><input type="number" name="checklist[3][obtained_marks]" class="form-control"
                                value="{{ old('checklist.3.obtained_marks', $evaluation->checklist[3]['obtained_marks'] ?? 0) }}"></td>
                        <td><input type="text" name="checklist[3][remarks]" class="form-control"
                                value="{{ old('checklist.3.remarks', $evaluation->checklist[3]['remarks'] ?? '') }}"></td>
                    </tr>
